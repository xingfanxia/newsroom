...
- Shared feed query defaults and bounds through `lib/feed/query-defaults.ts`;
  ...
  installable skill markdown, and the generated OpenAPI feed docs no longer carry separate
...
- Shared search query defaults and bounds through `lib/search/query-defaults.ts`;
  ...
  semantic result offsets, installable skill markdown, and generated OpenAPI search docs no longer carry
