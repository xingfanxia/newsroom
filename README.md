...
文档路由入口见 [`docs/README.md`](./docs/README.md)。当前架构（含 AI HOT 运行时行为和蓝图偏差）见 [`docs/architecture/ingestion.md`](./docs/architecture/ingestion.md)。已上线的 AI HOT 设计记录归档在 [`docs/aihot-integration/PLAN.md`](./docs/aihot-integration/PLAN.md)。Agent 接入设计见 [`docs/agent-access/`](./docs/agent-access/)。当前会话交接记录见 [`docs/HANDOFF.md`](./docs/HANDOFF.md)。
