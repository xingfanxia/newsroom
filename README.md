...
Docs routing starts at [`docs/README.md`](./docs/README.md). Current architecture, including AI HOT runtime behavior and blueprint deviations, lives in [`docs/architecture/ingestion.md`](./docs/architecture/ingestion.md). The shipped AI HOT design record is archived at [`docs/aihot-integration/PLAN.md`](./docs/aihot-integration/PLAN.md). Agent access surface is in [`docs/agent-access/`](./docs/agent-access/). Current handoff notes are in [`docs/HANDOFF.md`](./docs/HANDOFF.md).
